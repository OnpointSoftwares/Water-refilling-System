...
<div class="card card-outline card-primary">
    ...
    <h3 class="card-title"><?php echo !isset($id) ? "Create New" : "Manage" ?> Water Refill</h3>
    </div>
    <div class="card-body">
            ...
            <form id="sales-form">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <?php  $user=$_SESSION['userdata']['firstname'];?>
                        <input type="text" name="customer_name" class="form-control" id="customer_name" value="<?php echo isset($customer_name) ?  $customer_name : $user ?>" reqiured readonly>
                    </div>
                    <div class="form-group col-sm-6">
